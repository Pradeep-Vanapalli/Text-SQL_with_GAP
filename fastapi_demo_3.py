...
def process_selected_value(selected_value: str, db:str):
    ...
    quest = ["What is the monthly churn rate",
             ...
             "How many of these customers have placed 1 order?",
             "How many of these customers have placed less than 2 orders?",
    ...
    sql = [
        ...
        "SELECT COUNT(DISTINCT customer_id) AS customers_with_more_than_2_orders FROM (SELECT customer_id, COUNT(*) AS order_count FROM orders  GROUP BY customer_id) a WHERE  order_count = 1",
        "SELECT COUNT(DISTINCT customer_id) AS customers_with_more_than_2_orders FROM (SELECT customer_id, COUNT(*) AS order_count FROM orders  GROUP BY customer_id) a WHERE  order_count < 2",
